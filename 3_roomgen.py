...
def linkrgt(id0, id1, a, b, c, d, z, y, nosee=False):
...
def linklft(id0, id1, a, b, c, d, z, y, nosee=False):
...
def linkuwd(id0, id1, a, b, c, d, x, z, nosee=False):
...
def linkdwn(id0, id1, a, b, c, d, x, z, nosee=False):
...
def linkfwd(id0, id1, a, b, c, d, x, y, nosee=False):
...
def linkbwd(id0, id1, a, b, c, d, x, y, nosee=False):
...
def rgt(id0,z0,y0, id1,z1,y1, d,h, nosee=False):
	linkrgt(id0, id1, z0-d, z0+d, y0-h, y0+h, z0-z1, y0-y1, nosee)
	linklft(id1, id0, z1-d, z1+d, y1-h, y1+h, z1-z0, y1-y0, nosee)

def lft(id0,z0,y0, id1,z1,y1, d,h, nosee=False):
	linklft(id0, id1, z0-d, z0+d, y0-h, y0+h, z0-z1, y0-y1, nosee)
	linkrgt(id1, id0, z1-d, z1+d, y1-h, y1+h, z1-z0, y1-y0, nosee)

def uwd(id0,x0,z0, id1,x1,z1, w,h, nosee=False):
	linkuwd(id0, id1, x0-w, x0+w, z0-h, z0+h, x0-x1, z0-z1, nosee)
	linkdwn(id1, id0, x1-w, x1+w, z1-h, z1+h, x1-x0, z1-z0, nosee)

def dwn(id0,x0,z0, id1,x1,z1, w,h, nosee=False):
	linkdwn(id0, id1, x0-w, x0+w, z0-h, z0+h, x0-x1, z0-z1, nosee)
	linkuwd(id1, id0, x1-w, x1+w, z1-h, z1+h, x1-x0, z1-z0, nosee)

def fwd(id0,x0,y0, id1,x1,y1, w,h, nosee=False):
	linkfwd(id0, id1, x0-w, x0+w, y0-h, y0+h, x0-x1, y0-y1, nosee)
	linkbwd(id1, id0, x1-w, x1+w, y1-h, y1+h, x1-x0, y1-y0, nosee)

def bwd(id0,x0,y0, id1,x1,y1, w,h, nosee=False):
	linkbwd(id0, id1, x0-w, x0+w, y0-h, y0+h, x0-x1, y0-y1, nosee)
	linkfwd(id1, id0, x1-w, x1+w, y1-h, y1+h, x1-x0, y1-y0, nosee)
...
fwd(b0,25,-37, b1,-96,-37, 3,3)
lft(b1,5,-37, e,397,0, 3,3)
lft(b1,-5,-37, e,-397,0, 3,3)
fwd(b1,-97,-37, f,-6,0, 3,3)
fwd(b1,97, -37, f,6,0, 3,3)
bwd(f,0,0, d,0,0, 3,3)
rgt(b0,0,0, g,0,0, 3,3)
dwn(b0,0,0, g,0,0, 3,3)
lft(b0,0,0, g,0,0, 3,3)
bwd(b0,0,0, g,0,0, 3,3)
fwd(b0,0,0, g,0,0, 3,3)
dwn(g,0,0, h,0,0, 3,3)
fwd(f,0,-2, h,0,0, 3,1)

dwn(a,1,3, a0,0,0, 1,1)
fwd(b0,5,-36, a0,0,0, 4,4, nosee=1)


fwd(b0,0,-35, k0,0,0, 1,5)
fwd(j0,0,0, k1,0,0, 1,5)
fwd(j1,0,0, k2,0,0, 1,5)
fwd(j2,0,0, l0,0,0, 1,5)

fwd(j0,-6,0, k0,-6,0, 5,5)
fwd(j0,6,0, k0,6,0, 5,5)
fwd(j1,-6,0, k1,-6,0, 5,5)
fwd(j1,6,0, k1,6,0, 5,5)
fwd(j2,-6,0, k2,-6,0, 5,5)
fwd(j2,6,0, k2,6,0, 5,5)

fwd(l1,-5,0, l0,-6,0, 5,5)
fwd(l1,5,0, l0,6,0, 5,5)

dwn(l1,0,-90, l2,0,0, 10,10)
dwn(l2,0,0, l1,0,-90, 10,10)

fwd(l2,0,-90, l3,0,0, 10,10)
dwn(l3,9,9, l1,0,0, 1,1)
